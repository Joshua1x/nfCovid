...
library("easypackages");libraries("grid","rbin","data.table","progress","XML"
                                  ,"xml2","seqinr","data.table","readr","dplyr")
...
write.csv(summary,dx,row.names=FALSE)
write.csv(select(summary,"SampleNumber","Sample_ID","collectionDate","Run Name","lineage","num_actg","clade"),dx,row.names=FALSE)

# Generating the submission file
# ==============================
data1<-select(summary,"SampleNumber","Sample_ID","collectionDate","Run Name","lineage","num_actg")
